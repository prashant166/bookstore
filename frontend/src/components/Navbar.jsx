...
function Navbar() {
  ...
  return (<>
    <div className={` max-w-screen-container dark:bg-slate-800 dark:text-white mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50  ${
          sticky? "sticky-navbar shadow-md  bg-base-300 dark:bg-slate-800 dark:text-white duration-300 transition-all ease-in-out"
            : ""
        }`}
    >
